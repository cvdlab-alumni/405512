...
var settBY = buildSettlement([2*PI,0]); // Settlement B

/*	Exercise 5	*/

var colorGrey = [139/255,137/255,137/255];
var streetsA = COLOR(colorGrey)(CUBOID([0.7,settAY,0.01])); //streets of settlement A
var streetsB = COLOR(colorGrey)(T([0,1,2])([2*PI,0,0])(CUBOID([0.7,settBY,0.01]))); //streets of settlement B

var model = STRUCT([base, terrain, lake, streetsA, streetsB]);
DRAW(model);