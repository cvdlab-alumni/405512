...
function createUpperBodyCharacter(color){
	...
	var profile_armRight12UP = BEZIER(S0)([[0.3, 4.7, 0.45], [-0.5, 4.7, 0.45], [-0.5, 3.35, 0.45], [-0.5, 3.35, 1.2]]);
	var profile_armRight12DOWN = BEZIER(S0)([[0.3, 3.8, 0.45], [0.3, 3.8, 0.45], [0.3, 3.4, 0.45], [0.3, 3.4, 1.2]]);
	...
	var profile_armLeft12UP = BEZIER(S0)([[-0.3, 4.7, 0.45], [0.5, 4.7, 0.45], [0.5, 3.35, 0.45], [0.5, 3.35, 1.2]]);
	var profile_armLeft12DOWN = BEZIER(S0)([[-0.3, 3.8, 0.45], [-0.3, 3.8, 0.45], [-0.3, 3.4, 0.45], [-0.3, 3.4, 1.2]]);
...
function createHands(color){
	...
	//result
	var hands = COLOR(color)(STRUCT([bodyBack, bodyFront, bodyRight, bodyLeft, bodyTop]));
	return hands;
};
...
var character = STRUCT([lowerBody, upperBody, head]);
