...
var wheelBarrow = function(){
	...
	var pushingBar11 = COLOR(whiteColor)(cylinder(0.1, 6.5, 256));
	var pushingBar12 = COLOR(blackColor)(T([0,1,2])([0,0,6.5])(cylinder(0.1, 0.9, 256)));
	...
	var scTop2 = BEZIER(S0)([[-0.42,1.8,1.925],[-0.415,1.925,1.925],[4.1,1.82,1.925]]);
